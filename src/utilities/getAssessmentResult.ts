...
const REVERSE_SCORED_QUESTION_IDS = new Set([
  "question-5",
  "question-8",
  "question-9",
  "question-10",
...
export const getScoredAnswer = (questionId: string, value: string) => {
  const score = Number(value);

  if (Number.isNaN(score)) return 0;

  return REVERSE_SCORED_QUESTION_IDS.has(questionId) ? 6 - score : score;
};
...
export const getAssessmentTotalScore = (
  ...
  return questions.reduce((total, question) => {
    ...
    return total + getScoredAnswer(question.id, answer);
  }, 0);
};
...
export const assessmentResultContent: Record<
  AppResultLevel,
  AppResultContent
> = {
  low: {
    ...
    body: [
      "Based on your responses, you seem to have a healthy balance in your day-to-day life. You're managing stress, maintaining your energy, and staying connected in ways that support your well-being.",
