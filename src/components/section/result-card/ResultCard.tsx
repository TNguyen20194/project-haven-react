...
const ResultCard = ({
  ...
  <div className="p-5 bg-[hsl(var(--background))] border border-black/5 hover:dark:border-white/8 shadow-sm rounded-lg transition-all duration-300 ease-out hover:bg-[hsl(var(--teal))]/9 hover:shadow-md">
